    ...
    <div className={styles.formSection}>
      ...
      <div className={styles.row}>
        <div className={styles.inputGroup}>
          ...
          <input type="text" id="location" className={styles.inputField} value={data.location} onChange={onChange} placeholder="Dhangadhi, Nepal" />
        </div>
        <div className={styles.inputGroup}>
      ...
      <div className={styles.inputGroup}>
        <label htmlFor="summary">Executive Profile Summary</label>
        <textarea id="summary" className={styles.inputField} value={data.summary} onChange={onChange} placeholder="Driven developer with experiences in building modern scaling systems..." />
      </div>
    </div>
  );
};
